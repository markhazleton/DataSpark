...
public class SchemaServiceTests : DatabaseTestBase
{
    ...
    private Mock<IOptions<DataSparkOptions>> _mockOptions = null!;
    private SchemaService _schemaService = null!;
    private DataSparkOptions _options = null!;
    ...
    public override async Task TestInitialize()
    {
        ...
        _mockOptions = new Mock<IOptions<DataSparkOptions>>();

        _options = new DataSparkOptions
        {
