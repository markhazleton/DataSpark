...
using DataSpark.Tests.Infrastructure;
using FluentAssertions;
using System.IO;

namespace DataSpark.Tests.Integration;
...
public class IntegrationTests : DatabaseTestBase
{
    ...
    public override async Task TestInitialize()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["DataSpark:Database:Timeout"] = "300",
                ["DataSpark:Export:IncludeHeaders"] = "true",
                ["DataSpark:Export:Delimiter"] = ",",
                ["DataSpark:Export:Encoding"] = "UTF-8"
            })
            .Build();
        ...
        services.Configure<DataSparkOptions>(configuration.GetSection("DataSpark"));
    ...
    public async Task ExportService_WithDifferentDelimiter_ShouldUseCorrectDelimiter()
    {
        ...
        var databaseConfig = new DataSpark.Core.Models.DatabaseConfiguration("TestDB", ConnectionString);
    ...
    {
        // Act
        var options = _serviceProvider.GetRequiredService<IOptions<DataSparkOptions>>().Value;
