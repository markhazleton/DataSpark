...
namespace DataSpark.Tests.Configuration;

[TestClass]
public class DataSparkOptionsTests
{
    [TestMethod]
    public void DataSparkOptions_DefaultValues_ShouldBeSetCorrectly()
    {
        // Act
        var options = new DataSparkOptions();
        ...
        DataSparkOptions.SectionName.Should().Be("DataSpark");
    }

    [TestMethod]
    public void DataSparkOptions_Properties_ShouldBeSettable()
    {
        // Arrange
        var options = new DataSparkOptions();
