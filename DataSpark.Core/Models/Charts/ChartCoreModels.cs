...
public class ChartConfiguration
{
    ...
    {
        get => ChartPalette;
        set => ChartPalette = value;
    }
    [NotMapped]
    public bool Is3D
    {
        get => string.Equals(ChartStyle, "3D", StringComparison.OrdinalIgnoreCase);
        set => ChartStyle = value ? "3D" : "2D";
    }
...
public class ChartFilter
{
    ...
    public string Value
    {
        get
        {
            ...
            if (!string.IsNullOrWhiteSpace(MinValue)) return MinValue;
            return IncludedValues.FirstOrDefault() ?? string.Empty;
        }
        set => Pattern = value;
    }
    [NotMapped]
